const ownerNumber = ["79919010148@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '79919010148' 
...
const byemsgimg = (numero, groupname) => {
    return `fallow ${numero}`
}
//Texto de despedidas na imagem quando welcome esta ativado
//Obs: não coloque o texto longo para a imagem não sumir

const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO GALO COM 434 COMANDOS, BATERIA: ${battery}`
}
//Texto no menu da imagem quando welcome esta ativado
//Obs: não coloque o texto longo para a imagem não sumir

const titlemenumsgimg = 'obg-por-entra'
...
const cr = '⸎岌Ꮇ𝚠 ㋦ ᏒΔ̸𝕿🌹⃘⃘⃘⃓⃖͜͜⃟⃦⃤ ⸎ ټ\n' 
...
const msgerr = 'poxa deu erro dessa vez, tente de novo😁'
// mensagem de erro
...
let mess = {
    wait: '⌛ TA CHEGANDO, SE NÃO CHEGAR ESQUECE ⌛',
    success: '✔️ Sucesso! ✔️',
    error: {
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=79919010148:+7 991 901-01-48\n' 
+ 'END:VCARD'
